...
export type Currency = 'RUB' | 'USD' | 'EUR' | 'THB' | 'AED' | 'VND';
...
export interface ParsedSearchParams {
  ...
  // Advanced semantic filters & Target Matching
  userTargetPrice?: number;
  userTargetSource?: string;
  benchmarkType?: 'gds_through_fare' | 'user_target';
...
export interface MissingQuestion {
  field: 'passengers' | 'cabinClass' | 'luggage' | 'returnDate' | 'targetPrice' | string;
  question: string;
  options: string[];
}
...
export interface QuickReplyOption {
  ...
  label: string;
  queryText: string;
  category?: 'tripType' | 'passengers' | 'cabinClass' | 'luggage' | 'corporate' | 'targetPrice' | 'general';
