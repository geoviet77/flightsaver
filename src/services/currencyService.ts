...
export class CurrencyService {
  ...
  private static readonly CACHE_TTL_SECONDS = 3600; // 1 час
  private static readonly CACHE_KEY = 'currency_exchange_rates_usd';
  ...
  /**
   * Получение актуальных курсов валют (через L2 CacheService и fallback)
   */
